...
std_last_month = data_last_month['Price'].std()
...
std_three_months_ago = data_three_months_ago['Price'].std()
...
x_limits = [data_lettura['Price'].min(), data_lettura['Price'].max()]
