...
THRESHOLD =0.65 # arbitrary value - tweak this to get different results
...
def train_rnn(X_train, y_train, DIM_INPUT, DIM_HIDDEN, DIM_OUTPUT, epochs=10, learning_rate=0.001):
    ...
    while loss>0.001 and epoch<10000:
...
for k, v in G.items():
    ...
    # Addestramento della RNN
    val_W_xh, val_W_hh, val_W_hy, val_b_h, val_b_y = train_rnn(TargetA, TargetB, input_dim, hidden_units, output_dim, epochs=200, learning_rate=0.05)
